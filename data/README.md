...
| `languages/<id>.json` | one file per language (<!--languages-->80<!--/--> ids, listed in `LANGUAGE_IDS` in `schema.ts`) |
...
modula3 #223388, icon null (#a0522d), snobol null (#9fc5d9), tcl #e4cc98`
